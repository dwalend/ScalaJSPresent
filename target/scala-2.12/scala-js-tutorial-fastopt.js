...
$c_Lnet_walend_intro2scala_Start$.prototype.init___ = (function() {
  ...
  this.FP$1 = new $c_Lnet_walend_present_SimpleSlide().init___T__sc_Seq("FP", new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lnet_walend_present_Shortcuts$(), $m_Lnet_walend_present_TextLine$().apply__T__Lnet_walend_present_Style__Lnet_walend_present_FragmentLine("Functional Programming", $m_Lnet_walend_present_Style$().Title$1)), $m_Lnet_walend_present_TextLine$().apply__T__Lnet_walend_present_Style__Lnet_walend_present_FragmentLine("Everything is Immutable", $m_Lnet_walend_present_Style$().HeadLine$1), $m_Lnet_walend_present_TextLine$().apply__T__Lnet_walend_present_Style__Lnet_walend_present_FragmentLine("Create New Immutable Things From What You Have", $m_Lnet_walend_present_Style$().HeadLine$1), $m_Lnet_walend_present_TextLine$().apply__T__Lnet_walend_present_Style__Lnet_walend_present_FragmentLine("Functions are First Class Citizens", $m_Lnet_walend_present_Style$().HeadLine$1), $m_Lnet_walend_present_TextLine$().apply__T__Lnet_walend_present_Style__Lnet_walend_present_FragmentLine("Because Functions are Objects", $m_Lnet_walend_present_Style$().SupportLine$1), $m_Lnet_walend_present_TextLine$().apply__T__Lnet_walend_present_Style__Lnet_walend_present_FragmentLine("Collections Have Higher Order Functions For Transforming Their Contents", $m_Lnet_walend_present_Style$().HeadLine$1), ($m_Lnet_walend_present_Shortcuts$(), $m_Lnet_walend_present_LinkTextLine$().apply__T__T__Lnet_walend_present_Style__Lnet_walend_present_FragmentLine("When Someone Says \"Monad\" Think \"I Can Use flatmap()\" ", "https://medium.com/@sinisalouc/demystifying-the-monad-in-scala-cc716bb6f534", $m_Lnet_walend_present_Style$().HeadLine$1))]));
  $m_Lnet_walend_present_Shortcuts$();
